            ...
            if (audioRef.current && currentTrack) {
                ...
                if (currentTrack.id) {
                    try {
                        ...
                        const listenerAddress = "0x423c9c2872a77336d0f559b87a775aab5d1b3a73d305ede01bed9a6817aa8591";
                        console.log(`Fetching signed URL for track ${currentTrack.id}, listener: ${listenerAddress}`);
                        ...
                        console.error("Error with signed URL, falling back to direct URL:", error);
